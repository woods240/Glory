...
namespace WebSite
{
    public abstract class ExcelInterpreter<T> where T : class, new()
    {
        ...
        protected virtual List<T> ConvertRecordListToEntity(List<Dictionary<string, object>> recordList)
        {
        ...
        public List<T> GetEntityList(bool strictMode = true)
        {
            ...
            // 6.将记录转换为实体
            return ConvertRecordListToEntity(recordList);
        }
